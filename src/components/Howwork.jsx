...
import h11 from "../images/how2.jpeg"
import h22 from "../images/how2.jpeg"
import h33 from "../images/how2.jpeg"

export const Howwork = () => {
    return (
        <div className='justify-center items-center py-20 px-3   '  >
            <h2 className='text-pink-800 text-xl flex p-2 justify-center text-center items-center'><b>How Does It Works ?</b></h2>
